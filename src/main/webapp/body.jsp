...
.cord-div {
	...
	max-width: 350px; /* Ensures the card doesn’t get too large */
	min-width: 300px;
	margin-bottom: 30px;
	display: flex;
	justify-content: center;
...
<body>
	...
	<!-- <section class="our-team team-11">
        <div class="container">
            ...
            <div class="row team-row">   
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/images/team/team-member0.jpg" alt="" width="100px" height="350px" >
                        <div class="det-o">
                            <h4>Arijit Sanyal</h4>
                            <i>Sr Mgr.-Head PCS Cloud Labs</i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/images/team/utpal-anand.jpg" alt="" width="100px" height="350px" >
                        <div class="det-o">
                            <h4>Utpal Anand Pathak</h4>
                            <i>Business Development Mgr.</i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/images/team/team-memb2.jpg" alt="" width="100px" height="350px" >
                        <div class="det-o">
                            <h4>Debamitra&nbsp;Banerjee</h4>
                            <i>Brand Ambassador</i>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="single-usr">
                        <img src="assets/images/team/harshita.jpg" alt="" width="100px" height="350px" ;>
                        <div class="det-o">
                            <h4>Harshita Lal</h4>
                            <i>Business Development Exec.</i>
                        </div>
                    </div>
                </div>
	...
	<div class="query-container query-color query-transition  duq-mweb">
		...
		<div class="color_change query-header collapsible">
			<span class="title_color query-title"> "Drop us a Query" <!-- Image for blinker animation -->
				<picture> <img height="23" width="23"
					src="assets/images/content/blinker_d.webp" alt="img"> </picture>
			</span>
			<!-- Chevron icon for collapsible functionality -->
			<span class="query-chevron-icon query-closed"> <svg
					xmlns="http://www.w3.org/2000/svg" width="1024" height="1024"
					viewBox="0 0 1024 1024" class="chevron">
                    <path
						d="M994.485 295.755l-497.544 497.544-496.941-497.544 84.932-84.932 412.009 412.009 412.009-412.009 85.534 84.932z"></path>
                </svg>
			</span>
		</div>
		...
		<div class="query-body query-otp-view appear-done enter-done content">
			...
			<div class="query-top-section ">
				<div class="query-box-img-center">
					<picture> <img width="250" height="73" fullbase="true"
						alt="Edureka 24x7 Support" title="24x7 Support" loading="lazy"
						src="assets/images/logo.jpg"> </picture>
				</div>
			</div>
			...
			<div class="query-talktous ">
				...
				<div class="query-talktous-info">
					<a href="tel:+91 89517 55408">+91 8697741611<br></a> <span>Available
						24x7 for your queries</span>
				</div>
			</div>
			...
			<form class="query-form">
				...
				<!-- Email input field -->
				<div class="position-relative form-group">
					<label class="query-label form-label" for="duqFormEmail-duq">Email
						Id</label> <input placeholder="Enter your email*" name="email"
						autocomplete="email" type="email" id="duqFormEmail-duq"
						class="duq_input__se4iR form-control">
				</div>
				<!-- Submit button for the form -->
				<button type="submit" class="query-submit btn btn-primary">SUBMIT
					QUERY</button>
			</form>
