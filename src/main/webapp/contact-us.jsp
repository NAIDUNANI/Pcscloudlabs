		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 contact-form">
					...
					%>
					        <h3 style="font-size: 19px; margin-top: 10px;">Thank you for contacting us, <%= contact.getName() %>!</h3>
					        <p>We have received your message. We'll get back to you at <%= contact.getEmail() %>.</p>
					<%
					    } else {
					%>
